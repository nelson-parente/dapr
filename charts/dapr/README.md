...
| `global.initContainers.sentry`                | Array of init containers to inject into sentry pods                                                                                                                                                     | `[]`                    |
| `global.initContainers.placement`             | Array of init containers to inject into placement pods                                                                                                                                                  | `[]`                    |
| `global.initContainers.operator`              | Array of init containers to inject into operator pods                                                                                                                                                   | `[]`                    |
| `global.initContainers.injector`              | Array of init containers to inject into sidecar injector pods                                                                                                                                           | `[]`                    |
| `global.initContainers.scheduler`             | Array of init containers to inject into scheduler pods                                                                                                                                                  | `[]`                    |
| `global.extraContainers.sentry`               | Array of extra sidecar containers to add to sentry pods                                                                                                                                                 | `[]`                    |
| `global.extraContainers.placement`            | Array of extra sidecar containers to add to placement pods                                                                                                                                              | `[]`                    |
| `global.extraContainers.operator`             | Array of extra sidecar containers to add to operator pods                                                                                                                                               | `[]`                    |
| `global.extraContainers.injector`             | Array of extra sidecar containers to add to sidecar injector pods                                                                                                                                       | `[]`                    |
| `global.extraContainers.scheduler`            | Array of extra sidecar containers to add to scheduler pods                                                                                                                                              | `[]`                    |
