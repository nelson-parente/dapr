...
func InitMetrics(appID, namespace string, rules []config.MetricsRule, legacyMetricsHTTPMetrics, replaceIdentifiers bool) error {
	...
	if err := DefaultHTTPMonitoring.Init(appID, legacyMetricsHTTPMetrics, replaceIdentifiers); err != nil {
		return err
	}
